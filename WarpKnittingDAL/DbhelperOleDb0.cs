...
namespace WarpKnitting.DAL
{
    ...
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionStringSQL145"].ToString();
        ...
        public static int GetMaxID(string FieldName, string TableName)
        {
            ...
            object obj = DbHelperSQLGetSingle(strsql);
            if (obj == null)
            {
                return 1;
            }
        ...
        static DataSet ds;
        public static DataSet ExecuteDataSet1(string SQLString)
        {
            OleDbConnection connection = new OleDbConnection(connectionString);
            ds = new DataSet();
            try
        ...
        public static void UpdateExecuteDataSet1(DataTable mTable)
        {
            da.Update(mTable);
        }
        ...
        public static object DbHelperSQLGetSingle(string SQLString)
        {
