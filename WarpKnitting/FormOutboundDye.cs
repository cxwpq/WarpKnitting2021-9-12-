...
{
    public partial class FormOutboundDye : Form
    {
        public Int32 n = 31;
        ...
        BindGvApply BindGvApply, BindGvApply1, BindGvApply2, BindGvApply3;
        BLL.OutboundDye dyeOutbound = new BLL.OutboundDye();
        BLL.Customer Customer = new BLL.Customer();
        BLL.Product Xinghao = new BLL.Product();

        public FormOutboundDye()
        {
            InitializeComponent();
            MyList1 = Customer.MyList_NoAll("名称", "染厂");//读买方的名称
            MyList2 = Xinghao.MyList_NoAll("型号", "白坯布");//读坏布的型号
            MyList3 = Customer.MyList_NoAll("名称", "布厂");//读染厂的名称
        ...
        private void FormLoad(object sender, EventArgs e)
        {
            ...
            BindGvApply3 = new BindGvApply(dataGridView1, ComboBox3, MyList3, 8);
        }
